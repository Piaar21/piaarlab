...
urlpatterns = [
    ...
    path('api/dashborad_get_sales_data/', views.dashborad_get_sales_data, name='dashborad_get_sales_data'),
    path('api/get_ranking_data/', views.get_ranking_data, name='get_ranking_data'),
    path('api/get_keyword_volume_recent_month/', views.get_keyword_volume_recent_month, name='get_keyword_volume_recent_month'),
    path('api/get_kpi_data/', views.get_kpi_data, name='get_kpi_data'),
    path('task/reregister/', views.task_reregister, name='task_reregister'),  # 추가된 URL 패턴
    path('tasks/upload_excel_data/', views.task_upload_excel_data, name='task_upload_excel_data'),
    path('tasks/download-bulk-traffic-sample-excel/', views.download_bulk_traffic_sample_excel, name='download_bulk_traffic_sample_excel'),
